...
Das Licht wird von der Oberfläche des Objekts und des Hintergrunds reflektiet. Es wird ein Abbild des Objektes in verschiedenen Grautönen erzeugt. Die Oberfläche ist zu erkennen, die Kontur wird nicht so klar dargestellt.
